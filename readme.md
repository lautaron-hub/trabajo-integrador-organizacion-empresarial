# Bot de Soporte Técnico Nivel 1 - WhatsApp Simulation (Clases OOP)
...
- **Capa de Negocio (`ChatbotSoporte`):** Clase que encapsula la base de datos de usuarios. Gestiona el historial de incidentes. Controla las transiciones lógicas entre estados.
- **Capa de Interfaz (`__main__`):** Hilo interactivo por consola. Simula las entradas y salidas de texto de WhatsApp de forma asrónica.
...
3. **Adherencia Estricta a PEP 8:** Formateo riguroso de espacios alrededor de operadores, tabulaciones consistentes y nomenclatura autodescriptiva de variables.
